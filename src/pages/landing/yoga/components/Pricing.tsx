...
const pricingData: PricingPlan[] = [
  { title: '4 lessons', description: 'Valid for all types of classes', price: 40, perClass: '$10 per class' },
  { title: '8 lessons', description: 'Valid for all types of classes', price: 72, perClass: '$9 per class' },
  { title: '16 lessons', description: 'Valid for all types of classes', price: 120, perClass: '$7 per class' },
  { title: 'Yoga for pregnant', description: 'Valid for all types of classes', price: 12, perClass: 'per class' },
]
  ...
  return (
    <>
      <section className="pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        <Container className="pt-2 pt-sm-4 pt-lg-5 mt-md-2">
          <Row>
            <Col md={5} xl={4} className="mb-5 mb-md-0" style={{ marginTop: '-125px' }}>
              <div className="position-sticky top-0" style={{ paddingTop: 125 }}>
                <h2 className="h1 pb-2 pb-lg-3">Choose a suitable subscription</h2>
                <Row>
                  <Col md={10}>
                    <p className="mb-4">The best yoga and meditation practices, adapted at a high level to the needs of the modern pace of life.</p>
                  </Col>
                </Row>
                <ul className="list-unstyled mb-0">
                  <li className="d-flex align-items-center mb-3">
                    <svg
                      className="d-block flex-shrink-0 text-primary"
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    ...
                    <div className="ps-2 ms-1">
                      <div className="text-nav fw-medium">lesson duration 90 minutes</div>
                    </div>
                  </li>
                  <li className="d-flex align-items-center mb-3">
                    <svg
                  ...
                  <li className="d-flex align-items-center">
                    ...
                    <div className="ps-2 ms-1">
                      <div className="text-nav fw-medium">valid for all types of classes</div>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <Col md={7} className="offset-xl-1">
              <div className="ps-md-4 ps-xxl-5">
                {pricingData.map((plan, idx) => (
                  <Card key={idx} className="border-0 bg-secondary rounded-4 position-relative mb-3">
                    <CardBody className="d-sm-flex align-items-start text-center text-sm-start">
                      <div className="w-100 pe-sm-4 mb-3 mb-sm-0" style={{ maxWidth: '27rem' }}>
                        <h3 className="mb-2">{plan.title}</h3>
                        <p className="fs-lg mb-0">{plan.description}</p>
                      </div>
                      <div className="w-100 pe-sm-3 mx-auto me-sm-0 mb-3 mb-sm-0" style={{ maxWidth: '8rem' }}>
                        <div className="h3 text-primary mb-0 mb-sm-2">${plan.price}</div>
                        {plan.perClass && <span className="fs-sm">{plan.perClass}</span>}
                      </div>
                      <button className="btn btn-sm btn-outline-primary stretched-link w-100 w-sm-auto" type="button">
                        Buy
                      </button>
                    </CardBody>
                  </Card>
