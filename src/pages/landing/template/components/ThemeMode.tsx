import intodark from '@/assets/img/landing/intro/dark-mode.jpg'
import intolight from '@/assets/img/landing/intro/light-mode.jpg'
  ...
  return (
    <>
      <section className="d-flex w-100 position-relative overflow-hidden">
            ...
            <div className="mx-n4 mx-sm-n5 mx-xl-0">
              <div className="mx-n5 mx-xl-0">
                <ImgComparisonSlider className="mx-n5 mx-xl-0">
                  <Image slot="first" src={intodark} alt="Dak Mode" />
                  <Image slot="second" src={intolight} alt="Light Mode" />
        ...
        <div className="position-absolute top-0 end-0 w-50 h-100" style={{ backgroundColor: '#f6f9fc' }} />
      </section>
    </>
  )
}
