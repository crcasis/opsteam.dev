...
const services: ServiceItem[] = [
  {
    ...
    description: 'We are experts in numerous container technologies such as Docker, Kubernetes, and Openshift. We are happy to share our expertise with you and implement your Kubernetes cluster in your chosen environment according to your needs, taking best practices into account.',
    color: 'text-warning',
    icon: (
  ...
  },
  {
    ...
    description: 'CI & CD enable an automated pipeline for your software from the developer\'s laptop to the production environment. This ensures that your software is delivered to the customer in an automated, quality-assured, and secure manner. We can help you!',
    color: 'text-primary',
    icon: (
      <svg className="d-block mx-auto mb-4" width={56} height={56} viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  },
  {
    ...
    description: 'Do you need support with your projects or the architecture of an upcoming development? Our developers continuously train in the latest programming languages and monitor the latest trends. We are also happy to share our expertise in agile working with your developers.',
    color: 'text-primary',
    icon: (
      <svg className="d-block mx-auto mb-4" width={56} height={56} viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  return (
    <>
      <section className="container pt-sm-2 pt-md-3 pt-lg-4 pt-xl-5 mt-xxl-4 pb-lg-2 pb-xl-4 pb-xxl-5">
        <h2 className="h1 text-center pb-3 pb-lg-4">Services</h2>
        <Swiper
          spaceBetween={24}
        ...
        >
          {services.map((service, idx) => (
            <SwiperSlide className="h-auto" key={idx}>
              <Link className="card bg-secondary border-0 h-100 text-center text-decoration-none" to="">
                <CardBody>
                  {service.icon}
                  <h3>{service.title}</h3>
                  <p className="card-text">{service.description}</p>
                </CardBody>
                <CardFooter className="border-0 px-0 pt-0 pb-4 mb-3">
