          ...
          <Row className="mt-1 pt-sm-2 pt-md-3 pt-lg-4">
            <Col lg={5} className="mb-5 mb-lg-0">
              ...
              <form className="needs-validation row g-4" noValidate>
                ...
                <Col lg={10}>
                  ...
                  <textarea className="form-control form-control-lg" placeholder="Your message" rows={4} required id="message" />
                  <div className="invalid-feedback">Please write your message!</div>
                </Col>
                <Col lg={10}>
                  <button className="btn btn-lg btn-dark rounded-pill mt-2" type="submit">
                    Send request
                  </button>
                </Col>
              </form>
            ...
            <Col lg={7} xl={6} className="offset-xl-1">
              <Row className="row-cols-1 row-cols-sm-2">
                ...
                <Col className="d-flex flex-column pt-4 mt-sm-3">
                  <Card className="border-0 order-sm-2 mb-4 mb-sm-0">
                    <CardBody>
                      <svg className="d-block mb-3" width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          className="text-warning"
                  ...
                  <Card className="border-0 bg-primary order-sm-1 mb-sm-4" data-bs-theme="dark">
                    <CardBody>
                      <svg className="d-block mb-3" width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22.4844 22.4814H36.0031V36.0001H22.4844V22.4814Z" fill="white" />
                        <path
                          className="text-warning"
