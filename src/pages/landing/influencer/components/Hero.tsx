import hero from '@/assets/img/landing/influencer/hero.png'
  ...
  return (
    <>
      <section className="pt-5" style={{ background: 'linear-gradient(176.14deg, #f8f7e1 2.64%, #feeae7 94.95%)' }}>
        <Container className="pt-5" data-bs-theme="light">
          <Row className="align-items-center justify-content-center pt-3 pt-sm-4 mt-sm-3">
            <Col sm={9} md={8} lg={7} className="offset-lg-1 order-md-2 pb-3 pb-sm-0 mt-md-n5 mb-4 mb-sm-5">
              <div className="ps-md-4 ps-lg-0 mt-md-n4 mt-lg-n5">
                <h1 className="display-5 mb-lg-4">
                  Hi, I'm&nbsp;
                  <span className="text-dark fw-bolder" data-bs-theme="light">
                    Jane Cooper
                  </span>
                  <br />
                  Wellness &amp; lifestyle influencer
                </h1>
                <p className="text-body fs-lg">Workouts designed for optimal results. Start your journey to wellness with me!</p>
                <div style={{ maxWidth: '24rem' }}>
                  <div className="d-table text-dark mx-auto" data-bs-theme="light">
                    <div className="ms-n4">
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <div className="d-table position-relative text-dark mt-n3 mb-2" data-bs-theme="light">
            ...
            <Col xs={6} sm={5} md={4} className="order-md-1">
              <Image src={hero} width={416} alt="Influencer" />
            </Col>
          </Row>
        </Container>
      </section>
