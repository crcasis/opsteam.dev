  ...
  return (
    <>
      <section className="container pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
        <h2 className="h1 text-center pt-3 pt-sm-4 pt-lg-5 pb-3 mb-3 mb-lg-4">Our benefits</h2>
        <Row className="row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
          <Col>
            <Card className="card-flip">
              <div className="card-flip-inner">
                <div className="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-primary mb-4 mx-auto"
                      width={40}
                      height={40}
                      viewBox="0 0 40 40"
                      fill="currentColor"
                    ...
                    <p className="card-text">
                      Around users and partners can count on 24/7 technical assistance, as well as the help of the technical analytics department and
                      teams of specialized experts.
                    </p>
                  </CardBody>
                </div>
                <div className="card-flip-back bg-primary rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-white mt-2 mt-lg-n4 mb-4 mx-auto"
                      width={32}
                      height={32}
                      viewBox="0 0 32 32"
                      fill="currentColor"
                    ...
                    <div className="h3 display-4 text-white pb-1 mb-2">24/7</div>
                    <p className="card-text text-white opacity-70">
                      Around users and partners can count on 24/7 technical assistance, as well as the help of the technical analytics department and
                      teams of specialized experts.
                    </p>
                  </CardBody>
            ...
            <Card className="card-flip">
              <div className="card-flip-inner">
                <div className="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-danger mb-4 mx-auto"
                      width={40}
                      height={40}
                      viewBox="0 0 40 40"
                      fill="currentColor"
                ...
                <div className="card-flip-back bg-danger rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-white mt-2 mt-lg-n4 mb-4 mx-auto"
                      width={32}
            ...
            <Card className="card-flip">
              <div className="card-flip-inner">
                <div className="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-info mb-4 mx-auto"
                      width={40}
                      height={40}
                      viewBox="0 0 40 40"
                      fill="currentColor"
                    ...
                    >
                      ...
                      <path d="M23.33 21.146H27.7746C28.3882 21.146 28.8854 21.6436 28.8854 22.2572V37.8127C28.8854 38.4263 28.3882 38.9239 27.7746 38.9239H23.33C22.7164 38.9239 22.2188 38.4263 22.2188 37.8127V22.2572C22.2188 21.6436 22.7164 21.146 23.33 21.146Z" />
                      <path d="M34.4472 14.479H38.8914C39.505 14.479 40.0026 14.9766 40.0026 15.5903V37.8123C40.0026 38.4259 39.505 38.9236 38.8914 38.9236H34.4472C33.8336 38.9236 33.3359 38.4259 33.3359 37.8123V15.5903C33.3359 14.9766 33.8336 14.479 34.4472 14.479Z" />
                    ...
                    <h3>Reliable data</h3>
                    <p className="card-text">
                      Thanks to our platform, developed using advanced data management methods, data quality reaches 100%, which is 20% better than
                      other platforms.
                    </p>
                  </CardBody>
                </div>
                <div className="card-flip-back bg-info rounded-5 py-2 py-lg-4 px-0">
                  <CardBody className="text-center">
                    <svg
                      className="d-block text-white mt-2 mt-lg-n4 mb-4 mx-auto"
                      width={32}
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M0.888997 20.4722H4.44434C4.93522 20.4722 5.33333 20.87 5.33333 21.3608V30.2498C5.33333 30.7407 4.93522 31.1388 4.44434 31.1388H0.888997C0.398112 31.1388 0 30.7407 0 30.2498V21.3608C0 20.87 0.398112 20.4722 0.888997 20.4722Z" />
                      <path d="M9.7793 13.3608H13.335C13.8258 13.3608 14.224 13.759 14.224 14.2498V30.2498C14.224 30.7407 13.8258 31.1388 13.335 31.1388H9.7793C9.28841 31.1388 8.89062 30.7407 8.89062 30.2498V14.2498C8.89062 13.759 9.28841 13.3608 9.7793 13.3608Z" />
                      <path d="M18.6702 16.9165H22.2259C22.7168 16.9165 23.1146 17.3146 23.1146 17.8055V30.2498C23.1146 30.7407 22.7168 31.1388 22.2259 31.1388H18.6702C18.1794 31.1388 17.7812 30.7407 17.7812 30.2498V17.8055C17.7812 17.3146 18.1794 16.9165 18.6702 16.9165V16.9165Z" />
                      <path d="M27.5531 11.5835H31.1084C31.5993 11.5835 31.9974 11.9816 31.9974 12.4725V30.2502C31.9974 30.7411 31.5993 31.1392 31.1084 31.1392H27.5531C27.0622 31.1392 26.6641 30.7411 26.6641 30.2502V12.4725C26.6641 11.9816 27.0622 11.5835 27.5531 11.5835V11.5835Z" />
                      <path d="M29.3333 0.916504C27.8613 0.918132 26.6683 2.11117 26.6667 3.58317C26.6702 3.87353 26.7217 4.1613 26.819 4.43473L22.3691 7.07991C21.7852 6.46045 20.9385 6.16032 20.0947 6.27327C19.2507 6.38623 18.513 6.8986 18.1123 7.6499L14.1875 5.70589C14.2067 5.59163 14.2181 5.4764 14.2223 5.36084C14.2243 4.28141 13.5755 3.30745 12.5788 2.89307C11.582 2.479 10.4339 2.70654 9.67057 3.46956C8.9069 4.23258 8.67871 5.38037 9.09245 6.37744L4.0013 10.1769C3.59766 9.93636 3.13672 9.8081 2.66667 9.8055C1.19401 9.8055 0 10.9992 0 12.4722C0 13.9448 1.19401 15.1388 2.66667 15.1388C4.13932 15.1388 5.33333 13.9448 5.33333 12.4722C5.33105 12.1512 5.27051 11.8338 5.15462 11.5347L10.2965 7.6971C11.3024 8.25797 12.557 8.09359 13.3841 7.29215L17.8473 9.50277C18.1449 10.828 19.3919 11.7173 20.7419 11.5669C22.0918 11.4165 23.1126 10.2749 23.111 8.9165C23.111 8.84879 23.096 8.78499 23.0911 8.71859L27.931 5.84131C28.3506 6.10661 28.8366 6.24821 29.3333 6.24984C30.806 6.24984 32 5.05583 32 3.58317C32 2.11051 30.806 0.916504 29.3333 0.916504V0.916504Z" />
                    </svg>
                    <div className="h3 display-4 text-white pb-1 mb-2">100%</div>
                    <p className="card-text text-white opacity-70">
                      Thanks to our platform, developed using advanced data management methods, data quality reaches 100%, which is 20% better than
                      other platforms.
                    </p>
