...
export const testimonialSlides: TestimonialItem[][] = [
  [
    {
      name: 'Nadia Miles',
      text: 'Netus vel, amet placerat eget sit eleifend. Urna laoreet ultricies orci feugiat amet egestas semper praesent. Risus ut porttitor metus tortor quis eleifend.',
      avatar: avatar44,
      class: 'align-self-end pb-3 mb-2 mb-md-3 mb-xl-4',
    },
    {
      name: 'Eleanor Pena',
      text: 'Sit facilisis dolor arcu, fermentum vestibulum arcu elementum imperdiet. Mauris duis eleifend faucibus amet sagittis amet consequat aucibus cursus.',
      avatar: avatar45,
      class: 'align-self-center pb-3 mb-2 mb-md-3 mb-xl-4',
    },
    {
      name: 'Ralph Edwards',
      text: 'Morbi ut aliquam etiam luctus feugiat ultrices. Amet pellentesque sagittis, consequat id egestas tristique turpis. Arcu odio ultricies blandit eu neque.',
      avatar: avatar46,
...
const Testimonial = () => {
  return (
    <>
      <section className="container py-5 mt-3 mb-2 my-md-4 my-lg-5">
        <Row
          className="justify-content-center align-items-center py-xl-3 my-xxl-3"
          data-aos="fade-up"
        ...
        >
          <Col
            lg={5}
            className="pb-3 pb-lg-0 mb-3 mb-sm-4 mb-lg-0"
            data-aos="fade-up"
          ...
          >
            <div className="pe-lg-4 pe-xl-0">
              <h2 className="h1 text-center text-lg-start mb-0 mx-auto mx-lg-0" style={{ maxWidth: 468 }}>
                What our clients say about their
                <span className="d-inline-block position-relative">
                  <span className="position-relative z-2 mx-2">experience</span>
                  <svg
                    className="position-absolute top-50 end-0 translate-middle-y me-n1 mt-1"
                    width={249}
                    height={46}
                    viewBox="0 0 249 46"
                    fill="none"
              ...
              <div className="d-flex align-items-center justify-content-center justify-content-lg-start pt-4 mt-lg-3">
          ...
          <Col sm={10} md={8} lg={7} className="pb-2 pb-sm-1 pb-md-0">
            <Swiper
              effect="fade"
              ...
              {testimonialSlides.map((group, index) => (
                <SwiperSlide className="bg-light" key={index}>
                  <div className="d-flex flex-column">
                    {group.map((item: TestimonialItem, idx) => (
                      <div key={idx} className={`d-flex align-items-center ${item.class}`} style={{ maxWidth: 570 }}>
                        <div className="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style={{ padding: '.375rem' }}>
                          <Image className="rounded-circle" src={item.avatar} width={80} alt="Avatar" />
                        </div>
                        <Card className="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                          <CardBody className="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                            <p className="fs-xl">"{item.text}"</p>
                            <div className="h5 fw-bold mb-0">{item.name}</div>
                          </CardBody>
                        </Card>
                      </div>
                    ))}
