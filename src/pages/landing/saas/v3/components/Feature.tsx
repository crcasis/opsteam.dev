  ...
  return (
    <>
      <section className="container py-5 my-sm-2 my-md-4 my-lg-5">
        <h2 className="h1 text-center pt-sm-3 mt-xxl-3 mx-auto" style={{ maxWidth: '40rem' }}>
          What do you get with our tool?
        </h2>
        <p className="fs-lg text-center pb-3 mb-lg-4 mx-auto" style={{ maxWidth: '30rem' }}>
          Make sure all your tasks are organized so you can set the priorities and focus on important.
        </p>
        <Row className="row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-3 gy-sm-4 gy-xl-5 gx-4 gx-md-5 pb-xxl-4 mb-sm-2 mb-lg-0 mb-xl-2">
          <Col>
          ...
          <Col>
            <div className="text-center px-xxl-4">
              ...
              <h3 className="h4 mb-2">Tasks analytics</h3>
          ...
          <Col>
            <div className="text-center px-xxl-4">
              ...
              <h3 className="h4 mb-2">Light / dark mode</h3>
              <p>A elementum, imperdiet enim, pretium etiam facilisi in aenean quam inrean mauris ultrices interdum congue ut, dictum et tortor.</p>
            </div>
          </Col>
          <Col>
            <div className="text-center px-xxl-4">
          ...
          <Col>
            <div className="text-center px-xxl-4">
              ...
              <h3 className="h4 mb-2">Sections &amp; subtasks</h3>
              <p>
                Mi feugiat hac id in. Sit elit placerat lacus nibh lorem ridiculus lectus porttitor tincidunt sapien luctus tristique quam aenean
                accumsan.
              </p>
            </div>
          </Col>
