import saas01dark from '@/assets/img/landing/saas-3/hero/01-dark.png'
import saas01light from '@/assets/img/landing/saas-3/hero/01-light.png'
import saas02dark from '@/assets/img/landing/saas-3/hero/02-dark.png'
import saas02light from '@/assets/img/landing/saas-3/hero/02-light.png'
import saas03dark from '@/assets/img/landing/saas-3/hero/03-dark.png'
import saas03light from '@/assets/img/landing/saas-3/hero/03-light.png'
import saas04dark from '@/assets/img/landing/saas-3/hero/04-dark.png'
import saas04light from '@/assets/img/landing/saas-3/hero/04-light.png'
  ...
  return (
    <>
      <section className="bg-secondary py-5">
        <Container className="text-center pt-5 mt-lg-4 mt-xl-5">
          <div className="position-relative mx-auto my-3" style={{ maxWidth: 850 }}>
            <h1 className="display-3 position-relative z-2 mb-0">Task management assistant you gonna love</h1>
          ...
          <p className="fs-lg pb-3 mb-2 mb-sm-3 mb-lg-4 mx-auto" style={{ maxWidth: 640 }}>
            We offer you a new generation of task and project management system. Plan, manage and track all your tasks in one flexible software!
          </p>
          <Link className="btn btn-lg btn-primary" to="">
            Get early access
          </Link>
        </Container>
        <Container fluid className="overflow-hidden px-4 pt-3 pt-sm-4 pb-sm-2 pb-md-3 py-lg-4 py-xl-5 mt-4">
          <Parallax>
            <div className="parallax mx-auto" style={{ maxWidth: 1440 }}>
              <div className="parallax-layer" data-depth="0.1">
                <Image className="d-dark-mode-none" src={saas01light} alt="Layer" />
                <Image className="d-none d-dark-mode-block" src={saas01dark} alt="Layer" />
              </div>
              <div className="parallax-layer z-2" data-depth="0.25">
                <Image className="d-dark-mode-none" src={saas02light} alt="Layer" />
                <Image className="d-none d-dark-mode-block" src={saas02dark} alt="Layer" />
              </div>
              <div className="parallax-layer z-1" data-depth="0.35">
                <Image className="d-dark-mode-none" src={saas03light} alt="Layer" />
                <Image className="d-none d-dark-mode-block" src={saas03dark} alt="Layer" />
              </div>
              <div className="parallax-layer z-1" data-depth="0.45">
                <Image className="d-dark-mode-none" src={saas04light} alt="Layer" />
                <Image className="d-none d-dark-mode-block" src={saas04dark} alt="Layer" />
              </div>
            </div>
          </Parallax>
        </Container>
