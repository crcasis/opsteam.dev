...
const Footer = () => {
  return (
    <>
      <footer className="footer position-relative z-2 pb-3 pb-xl-0">
        <div className="d-none d-lg-block" style={{ marginTop: '-70px' }} />
        <div className="d-none d-md-block d-lg-none" style={{ marginTop: '-100px' }} />
        <div className="d-md-none" style={{ marginTop: '-130px' }} />
        <Container>
          <Row>
            <Col xs={12} xl={3} className="pb-sm-2 pb-md-3 mb-4 mb-lg-5 mb-xl-0">
              <div className="d-flex align-items-center mb-3 mb-xl-0">
                ...
                <select className="form-select form-select-sm d-xl-none" style={{ maxWidth: 130 }}>
              ...
              <div className="d-flex flex-wrap flex-xl-column ps-xl-5 ms-n3 ms-xl-2">
                <ul className="nav flex-xl-column">
                  <li className="nav-item mb-1">
                    <Link to="" className="nav-link py-1 px-xl-0">
                      About us
                    </Link>
                  </li>
                  <li className="nav-item mb-1">
                    <Link to="" className="nav-link py-1 px-xl-0">
                      Careers
                      <span className="badge bg-danger bg-opacity-10 rounded-pill ms-2">
                        <span className="text-danger">Hiring</span>
                      </span>
                    </Link>
                  </li>
                  <li className="nav-item mb-1">
            ...
            <Col sm={6} md={4} xl={3} className="pb-1 mb-4">
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-warning bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-message text-warning fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Speech recognition
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-success bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-file text-success fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Files transcription
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-info bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-terminal text-info fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Code generation
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-danger bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-search text-danger fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Smart search
            ...
            <Col sm={6} md={4} xl={3} className="pb-1 mb-4">
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-share text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Social networks
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-cart text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    E-commerce
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-calendar-check text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-mail text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Email / Chat apps
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-code text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Code editors
            ...
            <Col md={4} xl={3} className="pb-1 mb-4">
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-file-text text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Documentation
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-circle-info text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Help center
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-edit-alt text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    Blog articles
              ...
              <div className="position-relative d-flex align-items-center py-2 my-1">
                <div className="bg-primary bg-opacity-10 rounded-circle lh-1 p-3">
                  <i className="ai-github text-primary fs-4 lh-1" />
                </div>
                <div className="nav flex-column ps-3">
                  <Link to="" className="nav-link fw-semibold stretched-link p-0">
                    GitHub projects
          ...
          <div className="text-sm-center pb-3 py-sm-3 py-md-4 py-xl-5">
            <p className="nav d-block fs-sm mb-0">
              <span className="text-body">© All rights reserved. Made by </span>
              <Link className="av-link d-inline-block p-0" to="https://stackbros.in/" target="_blank" rel="noopener">
                Stackbros
              </Link>
            </p>
          </div>
