    ...
    <>
      <section className="position-relative overflow-hidden py-5">
        <span
          ...
          style={{ background: 'linear-gradient(141deg, rgba(255, 255, 255, .01) 17.3%, #f6f9fc 78.21%)' }}
        />
        <div
          className="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block"
          style={{ background: 'linear-gradient(141deg, rgba(18, 21, 25, .00) 17.3%, rgba(255, 255, 255, .03) 78.21%)' }}
        />
        <Container className="position-relative z-2 pt-3 pt-md-4 pt-lg-5 mt-lg-2 mt-xl-4">
          <h2 className="h1 text-center pb-1 mb-2">What you can build with Around</h2>
          ...
          <Row className="align-items-center justify-content-center py-4 py-md-5 my-1 my-sm-3 my-md-0 my-xl-3">
            <Col xs={11} sm={9} md={7} lg={6} className="offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
              <Parallax>
                <div className="parallax" style={{ maxWidth: 636 }}>
                  <div className="parallax-layer" data-depth={0}>
                    {/* <div className="ratio" style={{-arAspectRatio: '89.6%'}} /> */}
                  </div>
                  <div className="parallax-layer" style={{ paddingRight: '24.2%' }} data-depth="0.1">
                    <Image
                      src={linechartlight}
                      className="d-dark-mode-none position-relative rounded-4"
                      style={{ top: '27.5%', maxWidth: 482, boxShadow: '0 12px 48px -8px rgba(189, 196, 221, .35)' }}
                      alt="Total users line chart"
                    />
                    <Image
                      src={linechartdark}
                      className="d-none d-dark-mode-block position-relative rounded-4"
                      style={{ top: '27.5%', maxWidth: 482, boxShadow: '0 12px 48px -8px rgba(0, 0, 0, .25)' }}
                      alt="Total users line chart"
                    />
                  </div>
                  <div className="parallax-layer" style={{ paddingLeft: '45.75%' }} data-depth="-0.12">
                    <Image
                      src={barchartlight}
                      className="d-dark-mode-none position-relative rounded-4"
                      style={{ maxWidth: 345, boxShadow: '0 0 48px -4px rgba(189, 196, 221, .35)' }}
                      alt="Traffic bar chart"
                    />
                    <Image
                      src={barchartdark}
                      className="d-none d-dark-mode-block position-relative rounded-4"
                      style={{ maxWidth: 345, boxShadow: '0 12px 48px -8px rgba(0, 0, 0, .35)' }}
                      alt="Traffic bar chart"
                    />
                  </div>
                  <div className="parallax-layer" style={{ paddingRight: '7.547%', paddingLeft: '44.97%' }} data-depth="0.3">
                    <Image
                      src={donutchartlight}
                      className="d-dark-mode-none position-relative rounded-4"
                      style={{ top: '60.75%', maxWidth: 302, boxShadow: '0 0 48px -4px rgba(189, 196, 221, .35)' }}
                      alt="Traffic donut chart"
                    />
                    <Image
                      src={donutchartdark}
                      className="d-none d-dark-mode-block position-relative rounded-4"
                      style={{ top: '60.75%', maxWidth: 302, boxShadow: '0 -12px 48px -8px rgba(0, 0, 0, .35)' }}
                      alt="Traffic donut chart"
                    />
                  </div>
                </div>
            ...
            <Col md={5} xl={4} className="offset-xl-1 order-md-1 text-center text-md-start">
              ...
              <p className="fs-lg pb-lg-2 mb-4">
                From complex analysis to stunning visualizations, our advanced AI technology can help you extract valuable insights and make
              ...
              <Parallax>
                <div className="parallax" style={{ maxWidth: 636 }}>
                  <div className="parallax-layer" data-depth="0.05">
                    <Image src={circle1} alt="Circle 1" />
                  </div>
                  <div className="parallax-layer" data-depth="0.1">
                    <Image src={circle2} alt="Circle 2" />
                  </div>
                  <div className="parallax-layer" data-depth="0.15">
                    <Image src={circle3} alt="Circle 3" />
                  </div>
                  <div className="parallax-layer" data-depth="0.2">
                    <div className="position-absolute top-50 start-50 translate-middle bg-primary rounded-circle p-4">
                      <div className="h1 text-white lh-1 p-sm-1 p-lg-3 m-1">AI</div>
                    </div>
                  </div>
                  <div className="parallax-layer" style={{ paddingRight: '28.7%', paddingLeft: '57%' }} data-depth="0.3">
                    <div className="position-relative">
                      ...
                      />
                      <svg
                        className="position-absolute top-0 start-0 z-2 text-dark"
                        viewBox="0 0 92 91"
                        fill="currentColor"
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '60%', paddingLeft: '27.6%' }} data-depth="0.45">
                    <div className="position-relative" style={{ top: '13.3%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg" fill="none">
                        <path
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '85.8%' }} data-depth="0.3">
                    <div className="position-relative" style={{ top: '32.7%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 92 92" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#D)">
                          <path
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '27.8%', paddingLeft: '62.9%' }} data-depth="0.35">
                    <div className="position-relative" style={{ top: '30.7%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 62 62" fill="#03a9f4" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '45%', paddingLeft: '45%' }} data-depth="0.45">
                    <div className="position-relative" style={{ top: '73.5%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 61 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '73.3%', paddingLeft: '11.1%' }} data-depth="0.25">
                    <div className="position-relative" style={{ top: '78.8%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '68.2%', paddingLeft: '21%' }} data-depth="0.4">
                    <div className="position-relative" style={{ top: '52.9%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 72 71" xmlns="http://www.w3.org/2000/svg" fill="#0061ff">
                  ...
                  <div className="parallax-layer" style={{ paddingRight: '16%', paddingLeft: '71.4%' }} data-depth="0.3">
                    <div className="position-relative" style={{ top: '67.6%' }}>
                      ...
                      <span
                        ...
                        style={{ backgroundColor: '#1c2126' }}
                      />
                      <svg className="position-absolute top-0 start-0 z-2" viewBox="0 0 82 81" fill="#5865f2" xmlns="http://www.w3.org/2000/svg">
            ...
            <Col xs={11} sm={9} md={7} lg={6} className="offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
              <div className="parallax" style={{ maxWidth: 636 }}>
                <div className="parallax-layer" data-depth="0.1">
                  <Image
                    src={windowlight}
                    className="d-dark-mode-none rounded-4"
                    style={{ boxShadow: '0 10.2px 41px -6.8px rgba(189, 196, 221, .30)' }}
                    alt="Chat bot UI window"
                  />
                  <Image
                    src={windowdark}
                    className="d-none d-dark-mode-block rounded-4"
                    style={{ boxShadow: '0 10.2px 41px -6.8px rgba(0, 0, 0, .20)' }}
                    alt="Chat bot UI window"
                  />
                </div>
                <div className="parallax-layer" data-depth="0.15">
                  <Image src={message1light} className="d-dark-mode-none" alt="Message" />
                  <Image src={message1dark} className="d-none d-dark-mode-block" alt="Message" />
                </div>
                <div className="parallax-layer" data-depth="0.25">
                  <Image src={message2light} className="d-dark-mode-none" alt="Message" />
                  <Image src={message2dark} className="d-none d-dark-mode-block" alt="Message" />
                </div>
                <div className="parallax-layer" data-depth="0.35">
                  <Image src={message3light} className="d-dark-mode-none" alt="Message" />
                  <Image src={message3dark} className="d-none d-dark-mode-block" alt="Message" />
                </div>
              </div>
            </Col>
            <Col md={5} xl={4} className="offset-xl-1 order-md-1 text-center text-md-start">
              ...
              <p className="fs-lg pb-lg-2 mb-4">
                Seamlessly integrate natural language processing and machine learning capabilities into your chat bot and provide a personalized
          ...
          <div className="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-3 gap-sm-4 pt-4 pb-3 py-md-5 my-1 my-sm-3 my-md-0 mt-xl-3 mb-xl-4">
