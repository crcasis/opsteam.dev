    ...
    <>
      <section className="container pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
        <div className="d-flex align-items-center justify-content-between pb-4 mb-2 mb-md-3">
          <h2 className="h1 pt-1 mb-0">Trending products</h2>
        ...
        <div className="text-center mt-2 mt-md-0 mb-xxl-2 pt-4 pt-md-5 pb-2 pb-sm-3 pb-md-4">
          <Link className="btn btn-outline-primary w-100 w-sm-auto" to="/shop/catalog">
            View all products
          </Link>
        </div>
      </section>
