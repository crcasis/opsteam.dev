...
const features: FeatureItem[] = [
  ...
  },
  {
    ...
    description: 'We possess SSL / Secure certificate honcus egestas lorem honcus egestas',
    icon: (
      <svg width={40} height={40} viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <path
...
const Feature = () => {
  return (
    <>
      <section className="container py-5 mt-2 mb-3 mt-sm-3 mb-sm-4 my-md-4 my-lg-5">
        <Swiper
          slidesPerView={1}
          spaceBetween={24}
          breakpoints={{
          ...
          className="pb-xxl-4 mb-xl-2"
        >
          {features.map((item, index) => (
            <SwiperSlide key={index} className="text-center text-sm-start">
              <div className="text-primary mb-3 mb-sm-4">{item.icon}</div>
              <h3 className="h5 mb-2 mb-sm-3">{item.title}</h3>
