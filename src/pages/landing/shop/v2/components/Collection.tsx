import preview from '@/assets/img/landing/shop-2/popular/preview.jpg'
import th01 from '@/assets/img/landing/shop-2/popular/th01.png'
import th02 from '@/assets/img/landing/shop-2/popular/th02.png'
import th03 from '@/assets/img/landing/shop-2/popular/th03.png'
import th04 from '@/assets/img/landing/shop-2/popular/th04.png'
import th05 from '@/assets/img/landing/shop-2/popular/th05.png'
import th06 from '@/assets/img/landing/shop-2/popular/th06.png'
  ...
  return (
    <>
      <section className="container pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
        <h2 className="h1 text-md-center pb-2 pb-sm-3 pb-lg-4">Most popular collection</h2>
        <Row className="pb-2 pb-sm-3 pb-md-4 pb-xl-5 mb-lg-2">
          <Col sm={7} md={5} lg={6} className="mb-4 mb-md-0">
            <div className="h-100 bg-size-cover bg-position-center rounded-5 me-md-4 me-xl-5" style={{ backgroundImage: `url(${preview})` }}>
              <div className="ratio ratio-16x9" />
            </div>
          </Col>
          <Col md={7} lg={6} className="py-md-4">
            <div className="py-xl-2">
                ...
                <ul className="col d-flex flex-column list-unstyled m-0 gap-2 mb-2 mb-sm-0">
                  <li className="d-flex align-items-center gap-2">
                    ...
                    <div className="text-nowrap">
                      <Image src={th01} width={15} alt="Macaron" />
                      <Image src={th01} width={15} alt="Macaron" />
                      <Image src={th01} width={15} alt="Macaron" />
                    </div>
                    Salted caramel
                  ...
                  <li className="d-flex align-items-center gap-2">
                    2
                    <div className="text-nowrap">
                      <Image src={th02} width={15} alt="Macaron" />
                      <Image src={th02} width={15} alt="Macaron" />
                    </div>
                    Caramel Salé
                  </li>
                  <li className="d-flex align-items-center gap-2">
                    2
                    <div className="text-nowrap">
                      <Image src={th03} width={15} alt="Macaron" />
                      <Image src={th03} width={15} alt="Macaron" />
                    </div>
                    Simplement Chocolat
                  </li>
                </ul>
                <ul className="col d-flex flex-column list-unstyled m-0 gap-2">
                  <li className="d-flex align-items-center gap-2">
                    3
                    <div className="text-nowrap">
                      <Image src={th04} width={15} alt="Macaron" />
                      <Image src={th04} width={15} alt="Macaron" />
                      <Image src={th04} width={15} alt="Macaron" />
                    </div>
                    Follement Framboise
                  ...
                  <li className="d-flex align-items-center gap-2">
                    3
                    <div className="text-nowrap">
                      <Image src={th05} width={15} alt="Macaron" />
                      <Image src={th05} width={15} alt="Macaron" />
                      <Image src={th05} width={15} alt="Macaron" />
                    </div>
                  ...
                  <li className="d-flex align-items-center gap-2">
                    2
                    <div className="text-nowrap">
                      <Image src={th06} width={15} alt="Macaron" />
                      <Image src={th06} width={15} alt="Macaron" />
                    </div>
                    Bleuets-Cassis
                  </li>
              ...
              <div className="d-flex gap-4 mb-4">
                <div>
                  <svg className="d-block text-body mx-auto" xmlns="http://www.w3.org/2000/svg" width={28} height={27} fill="currentColor">
