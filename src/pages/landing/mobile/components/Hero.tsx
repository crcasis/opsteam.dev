  ...
  return (
    <>
      <section className="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
        <div className="bg-primary position-absolute start-0 bottom-0 w-100 d-none d-xl-block" style={{ height: 920 }} />
        <div className="bg-primary position-absolute start-0 bottom-0 w-100 d-none d-lg-block d-xl-none" style={{ height: 830 }} />
        <div className="bg-primary position-absolute start-0 bottom-0 w-100 d-lg-none d-xl-none" style={{ height: '62%' }} />
        <div
          className="bg-dark bg-opacity-10 rounded-circle position-absolute start-50 d-none d-lg-block"
          style={{ bottom: 220, width: 480, height: 480, marginLeft: '-240px' }}
          data-aos="zoom-in"
          data-aos-duration={700}
          data-aos-delay={200}
          data-aos-offset={300}
        />
        <Container className="position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
          <h1 className="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style={{ maxWidth: 680 }}>
          ...
          <Row className="justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
            <Col xs={8} lg={4} className="order-lg-2" style={{ marginTop: '-105px' }}>
              <div className="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style={{ paddingTop: 110 }}>
                <Image className="d-block mx-auto" src={screen02} width={322} alt="App screen" />
              </div>
            </Col>
            <Col sm={6} lg={4} className="order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
              <Image
              ...
              >
                ...
                <p className="text-white opacity-80 mb-0">
                  Fusce lectus neque viverra risus lobortis adipiscing integer pulvinar elementum. Lorem viverra tincidunt tortor pellentesque.
                </p>
              </div>
              <div
                className="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4"
              ...
              >
                ...
                <h2 className="h4 text-white mb-2 mb-lg-3">Large online library</h2>
                <p className="text-white opacity-80 mb-0">
                  Vulputate convallis odio donec massa facilisis sed nibh rhoncus, maecenas. Maecenas morbi est neque pellentesque.
                </p>
              </div>
            </Col>
            <Col sm={6} lg={4} className="order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
              <Image
              ...
              <div
                className="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                style={{ maxWidth: 340 }}
                data-aos="fade-left"
                data-aos-offset={250}
                data-aos-delay={400}
              ...
              >
                ...
                <h2 className="h4 text-white mb-2 mb-lg-3">Study convenient</h2>
                <p className="text-white opacity-80 mb-0">
                  Fermentum convallis mi posuere rutrum turpis duis facilisis integer. Rhoncus in in sit tellus velit quis laoreet morbi orci sed.
                </p>
              </div>
              <div
                className="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
              ...
              >
                ...
                <h2 className="h4 text-white mb-2 mb-lg-3">Tracking results</h2>
                <p className="text-white opacity-80 mb-0">
                  Arcu nisl aliquet vel pellentesque. Vitae nibh leo, facilisis laoreet metus, felis. Egestas id enim turpis tellus, nulla adipiscing.
                </p>
              </div>
            </Col>
          </Row>
