import features01 from '@/assets/img/landing/mobile-app-showcase/features/01.png'
import features02 from '@/assets/img/landing/mobile-app-showcase/features/02.png'
import features03 from '@/assets/img/landing/mobile-app-showcase/features/03.png'
  ...
  return (
    <>
      <section className="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        <Row className="align-items-center pt-3 pt-sm-4 pt-lg-5 mt-md-3 mt-lg-0">
          <Col md={6} className="pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
            <div className="binded-content bg-primary rounded-5">
              {featuresData.map((item, idx) => (
                <div key={idx} className={`binded-item ${activeIndex === idx ? 'active' : ''}`}>
                  {item.icon}
                  <Image className="d-block position-relative z-2" src={item.image} alt={`App screen ${item.number}`} />
                </div>
              ))}
            </div>
          </Col>
          <Col md={6} xl={5} className="offset-xl-1">
            <div className="ps-md-4 ps-xl-0">
              ...
              >
                {featuresData.map((item, idx) => (
                  <SwiperSlide key={idx}>
                    <div className="text-primary fs-xl fw-bold mb-3">{item.number}</div>
                    <h2 className="h1 mb-lg-4">{item.title}</h2>
              ...
              <div className="d-flex justify-content-center justify-content-md-start pt-4 mt-2 mt-lg-0 pt-lg-5">
                <button className="btn btn-icon btn-outline-primary rounded-circle me-3" type="button" id="prev-feature" aria-label="Prev">
                  <i className="ai-arrow-left" />
                </button>
                <button className="btn btn-icon btn-outline-primary rounded-circle" type="button" id="next-feature" aria-label="Next">
