import wave from '@/assets/img/landing/web-studio/hero-wave.png'
        ...
        >
          ...
          <Container className="position-relative z-2 pt-xl-4 pt-xxl-5 pb-sm-2">
            <Row className="pt-md-3 pt-lg-5">
              <Col lg={6} xxl={5} className="pb-lg-5 mb-xl-5">
                <h1 className="display-1 text-center text-lg-start mb-xxl-5">
                  Web studio of effective <span className="text-primary">development</span>
                </h1>
              </Col>
              <Col lg={5} xl={4} className="offset-lg-1 offset-xxl-2 d-flex flex-column pt-2 pt-md-4">
                <p className="text-body fs-xl text-center text-lg-start pb-2 pb-md-0 mb-4 mb-md-5">
                  We build websites, tools and applications that offer beautiful web presence and ultimate user experience.
                </p>
                <div className="d-flex flex-column flex-sm-row align-items-center justify-content-center justify-content-lg-start pb-3 pb-sm-5">
                  <Link className="btn btn-lg btn-primary rounded-pill w-100 w-sm-auto me-sm-3 me-xl-4 mb-2 mb-sm-0" to="">
                    Let's partner
                  </Link>
