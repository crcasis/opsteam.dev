  ...
  return (
    <>
      <section className="overflow-hidden pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
        <Container className="pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
          <div className="position-relative mx-auto" style={{ maxWidth: 1198 }}>
            ...
            <div
              className="position-absolute top-0 start-0 z-4"
              data-aos="zoom-in"
          ...
          <Row className="pt-5 mt-md-4">
            <Col md={6} xxl={5} className="offset-xxl-1 mb-4 mb-md-0">
              <div className="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
                ...
                <p className="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0" style={{ maxWidth: 475 }}>
                  Sapien ultrices egestas at faucibus on diam velit diam amet nibh in quam rutrum diam natoque scelerisque viverra pharetra quis massa
                  maecenas vulputate.
                </p>
            ...
            <Col md={6} className="mt-n3">
              <Row className="row-cols-2 row-cols-sm-3 row-cols-md-2 row-cols-lg-3 gy-md-2 gx-3">
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={klinosgray} width={120} alt="Klinos" />
                      <Image className="d-none d-dark-mode-block" src={klinoslight} width={120} alt="Klinos" />
                    </div>
                  </div>
                </Col>
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={starcraftgray} width={147} alt="Starcraft" />
                      <Image className="d-none d-dark-mode-block" src={starcraftlight} width={147} alt="Starcraft" />
                    </div>
                  </div>
                </Col>
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={airbnbgray} width={121} alt="Airbnb" />
                      <Image className="d-none d-dark-mode-block" src={airbnblight} width={121} alt="Airbnb" />
                    </div>
                  </div>
                </Col>
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={alpinegray} width={132} alt="Alpine" />
                      <Image className="d-none d-dark-mode-block" src={alpinelight} width={132} alt="Alpine" />
                    </div>
                  </div>
                </Col>
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={fostergray} width={132} alt="Foster" />
                      <Image className="d-none d-dark-mode-block" src={fosterlight} width={132} alt="Foster" />
                    </div>
                  </div>
                </Col>
                <Col>
                  <div className="ratio ratio-21x9 position-relative mx-auto" style={{ maxWidth: 180 }}>
                    <div className="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                      <Image className="d-block d-dark-mode-none" src={championgray} width={130} alt="Champion" />
                      <Image className="d-none d-dark-mode-block" src={championlight} width={130} alt="Champion" />
                    </div>
                  </div>
                </Col>
                <Col>
