...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="d-block mt-1 mt-sm-0 mb-4" width={40} height={40} viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <g className="text-primary">
          <path d="M19.9999 0C11.1313 0 3.61211 5.77313 0.992188 13.7659H39.0077C36.3877 5.77313 28.8686 0 19.9999 0Z" fill="currentColor" />
        </g>
        <g className="text-info">
          <path
  ...
  },
  {
    ...
    icon: (
      <svg className="d-block mt-1 mt-sm-0 mb-4" width={40} height={40} viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="text-primary">
          <path d="M39.3962 0H0.605469L20.0009 31.5477L39.3962 0ZM25.7601 7.62359L20.0009 16.9914L14.2416 7.62359H25.7601Z" fill="currentColor" />
        </g>
      </svg>
    ),
  },
  ...
  return (
    <>
      <section className="bg-secondary py-5">
        <Container className="py-3 py-sm-4 py-lg-5 my-md-2 my-lg-3 my-xl-4 my-xxl-5">
          <div className="fs-sm text-uppercase mb-3 mt-xl-2 mt-xxl-3">Work with us</div>
          <h2 className="h1 pb-3 mb-lg-4">Our services</h2>
          <Row className="row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 pb-xl-2 pb-xxl-3">
            {services.map((service, index) => (
              <Col key={index}>
                <Card className="h-100 border-0 rounded-5">
