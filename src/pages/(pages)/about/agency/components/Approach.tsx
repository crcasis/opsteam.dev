...
const approachData: ApproachItem[] = [
  {
    ...
    description: 'Find aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur neque congue aliqua dolor.',
    icon: (
  ...
  },
  {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eget molestie massa. Donec egestas nulla pariatur.',
    icon: (
      <svg className="d-block mt-1 mt-sm-0 mb-4" width={40} height={40} viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <g className="text-info">
          <path
  ...
  return (
    <>
      <section className="pt-5 mt-md-2 mt-xl-4 mt-xxl-5">
        <Container className="pt-2 pt-sm-4 pt-lg-5 mt-xxl-2">
          ...
          >
            {approachData.map((item, idx) => (
              <SwiperSlide key={idx} className="h-auto">
                <Card className="border-0 bg-secondary rounded-5 h-100">
                  <CardBody>
                    {item.icon}
