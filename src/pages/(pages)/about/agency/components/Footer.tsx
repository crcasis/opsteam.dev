...
const Footer = () => {
  return (
    <>
      <footer className="footer bg-dark position-relative py-4 py-md-5" data-bs-theme="dark">
        <Container className="position-relative z-2 pt-4 pt-md-2 pt-xl-4 pt-xxl-5">
          <Row className="py-md-3 mb-4 mb-md-5">
            <Col md={7} lg={6} xxl={5} className="mb-sm-4 mb-md-0">
              ...
              <div className="d-sm-flex align-items-center">
                <Link className="btn btn-lg btn-primary me-sm-3 me-lg-4" to="">
                  Let's work together
                </Link>
