          ...
          <Row className="pb-5 pt-sm-2 mb-lg-2">
            <Col md={4} lg={3} className="pb-2 pb-md-0 mb-4 mb-md-0">
              <Link className="navbar-brand py-0 mb-3 mb-md-4" to="/">
                ...
                <span className="text-light">Around</span>
              </Link>
            ...
            <Col md={8} lg={7} xl={6} className="offset-lg-2 offset-xl-3">
              <Row className="row-cols-1 row-cols-sm-3">
                ...
                <Col>
                  ...
                  <Link className="btn btn-secondary px-3 py-2 mt-3 me-3 me-md-0" to="">
                    <Image className="mx-1 d-dark-mode-none" src={googledark} width={119} alt="Google Play" />
                    <Image className="mx-1 d-none d-dark-mode-block" src={googlelight} width={119} alt="Google Play" />
                  </Link>
                </Col>
              </Row>
            </Col>
