import lightdark from '@/assets/img/landing/saas-2/steps/01-dark.png'
import lightlight from '@/assets/img/landing/saas-2/steps/01-light.png'
import step02dark from '@/assets/img/landing/saas-2/steps/02-dark.png'
import step02light from '@/assets/img/landing/saas-2/steps/02-light.png'
  ...
  return (
    <>
      <section className="overflow-hidden py-5 my-md-2 my-xl-4 my-xxl-5">
        <Container className="py-2 py-sm-4 py-lg-5">
          ...
          <Row className="align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
            ...
            >
              <Image className="d-dark-mode-none" src={lightlight} width={525} alt="Image" />
              <Image className="d-none d-dark-mode-block" src={lightdark} width={525} alt="Image" />
            </Col>
            <Col
              md={6}
              lg={5}
          ...
          <Row className="align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
            <Col
              ...
              data-disable-parallax-down="md"
            >
              <Image className="d-dark-mode-none" src={step02light} width={473} alt="Image" />
              <Image className="d-none d-dark-mode-block" src={step02dark} width={473} alt="Image" />
            </Col>
            <Col
              md={6}
              xl={4}
