...
const Tool = () => {
  return (
    <>
      <section className="container overflow-hidden py-5 my-md-3 my-lg-2 my-xl-4 my-xxl-5">
        <Row className="align-items-center my-2 py-2 py-sm-4 py-lg-5 my-xxl-2">
          ...
          <Col md={7} lg={6} className="offset-lg-1">
            <div className="position-relative mx-auto" style={{ maxWidth: 510 }}>
              <Image className="d-block d-dark-mode-none" src={circlegray1} style={{ animation: 'rotate-cw 100s linear infinite' }} alt="Circle" />
              <Image className="d-none d-dark-mode-block" src={circlelight1} style={{ animation: 'rotate-cw 100s linear infinite' }} alt="Circle" />
              <Image
