import girl from '@/assets/img/coming/girl.png'
...
const About = () => {
  ...
  return (
    <>
      <div className="w-sm-75 w-lg-100 p-4 overflow-hidden mx-auto mx-lg-0 order-lg-2" style={{ maxWidth: 1047 }}>
        <div className="p-sm-3 h-100">
          <div className="position-relative h-100">
            <div className="position-absolute top-0 end-0 h-100 bg-primary rounded-5 d-none d-lg-block" style={{ width: '93.9%' }} />
            <div className="position-absolute top-0 end-0 h-100 bg-primary rounded-4 d-lg-none" style={{ width: '93.9%' }} />
            <Parallax>
              <div className="parallax h-100 z-2 overflow-hidden">
                <div className="parallax-layer d-flex align-items-end mb-n2 mb-lg-0" style={{ marginTop: '4.4%' }} data-depth="0.1">
                  <Image src={girl} alt="Girl" />
                </div>
              </div>
            </Parallax>
            <div className="parallax position-absolute top-0 start-0 w-100 h-100 z-2">
              <div className="parallax-layer d-flex align-items-end" style={{ paddingRight: '75.6%', paddingBottom: '70%' }} data-depth="-0.1">
                <svg className="text-warning" xmlns="http://www.w3.org/2000/svg" width={239} height={233} viewBox="0 0 239 233" fill="none">
                  <style dangerouslySetInnerHTML={{ __html: '.B{stroke-miterlimit:10}.C{fill:currentColor}.D{stroke:#fff}.E{stroke-width:1.709}' }} />
                  <g className="C">
                    <g stroke="currentColor" strokeWidth="1.923" className="B">
                  ...
                  <use xlinkHref="#B" className="B D E" />
                  <use xlinkHref="#C" className="C" />
                  <use xlinkHref="#C" strokeLinecap="round" strokeLinejoin="round" className="B D E" />
                  <path d="M165.466 151.443l14.284-14.838-5.998-5.767" className="C" />
                  <path d="M165.466 151.443l14.284-14.838-5.998-5.767" className="B D E" />
                  <path d="M139.627 166.293l5.986 5.766 14.064-14.607" className="C" />
                  <path d="M139.627 166.293l5.986 5.766 14.064-14.607" className="B D E" />
                  <use xlinkHref="#D" className="C" />
                  <use xlinkHref="#D" className="B D E" />
                  <use xlinkHref="#E" className="C" />
                  <use xlinkHref="#E" className="B D E" />
                  <use xlinkHref="#F" className="C" />
                  <g className="B D E">
                    <use xlinkHref="#F" />
                    <path
              ...
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 59.35% 70.4% 30.4%' }} data-depth="0.2">
                <svg className="text-white" width={100} height={90} viewBox="0 0 100 90" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 11.58% 89.64% 81.28%' }} data-depth="-0.15">
                <svg className="text-warning" width={69} height={55} viewBox="0 0 69 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 70.94% 54.29% 24.4%' }} data-depth="-0.35">
                <svg className="text-warning" width={45} height={45} viewBox="0 0 45 45" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 69.6% 92.57% 26.37%' }} data-depth="-0.25">
                <svg className="text-white" width={39} height={38} viewBox="0 0 39 38" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 17.48% 74.58% 79.94%' }} data-depth="0.2">
                <div className="ratio ratio-1x1 border border-white border-2 rounded-circle" />
              </div>
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 87.38% 66.96% 11.27%' }} data-depth="0.15">
                <div className="ratio ratio-1x1 bg-white rounded-circle" />
              </div>
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 46.23% 91.84% 52.43%' }} data-depth="0.35">
                <div className="ratio ratio-1x1 bg-warning rounded-circle" />
              </div>
              <div className="parallax-layer d-flex align-items-end" style={{ padding: '0 3.6% 56.17% 94.93%' }} data-depth="0.4">
                <div className="ratio ratio-1x1 bg-warning rounded-circle" />
              </div>
            </div>
          </div>
      ...
      <div className="d-flex flex-column align-items-center w-lg-50 px-3 px-sm-4 px-xl-5 pt-lg-5 order-lg-1">
        <div className="w-100 d-none d-lg-block" style={{ maxWidth: 420 }}>
          <a className="navbar-brand text-dark p-0 m-0" href="/">
        ...
        <div className="w-100 text-center text-lg-start mt-auto pt-lg-5 pb-5" style={{ maxWidth: 420 }}>
          <h1 className="display-3 mb-4">We are coming soon</h1>
          ...
          <div className="countdown d-flex flex-wrap justify-content-center justify-content-lg-start pb-3 mb-4 mb-xl-5">
            <div className="text-center mb-2">
              <div className="bg-secondary rounded-1 p-2">
                <div className="h3 fw-medium mb-0 mx-1">{days}</div>
              </div>
            ...
            <div className="text-center mb-2">
              <div className="bg-secondary rounded-1 p-2">
                <div className="h3 fw-medium mb-0 mx-1">{hours}</div>
              </div>
            ...
            <div className="text-center mb-2">
              <div className="bg-secondary rounded-1 p-2">
                <div className="h3 fw-medium mb-0 mx-1">{minutes}</div>
              </div>
            ...
            <div className="text-center mb-2">
              <div className="bg-secondary rounded-1 p-2">
                <div className="h3 fw-medium mb-0 mx-1">{seconds}</div>
              </div>
        ...
        <div className="w-100 mt-auto pb-5" style={{ maxWidth: 420 }}>
          <div className="d-flex justify-content-center justify-content-lg-start gap-3">
            <Link className="btn btn-icon btn-sm btn-secondary btn-facebook rounded-circle" to="" aria-label="Facebook">
