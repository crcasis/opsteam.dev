...
const Testimonial = () => {
  return (
    <>
      <section className="container mt-n3 mt-sm-0 py-md-3 py-lg-4">
        <TabContainer defaultActiveKey={'foster'}>
          <h2 className="text-center pb-3 mb-lg-4">More than 2,000 clients using Around to analyze data</h2>
