      ...
      <section className="bg-secondary py-sm-2 py-lg-3 py-xl-4 py-xxl-5">
        <Container className="py-5">
          ...
          <Swiper
            ...
            className="pb-2 pb-sm-3 pb-lg-4"
          >
            <SwiperSlide>
            ...
            <SwiperSlide>
              ...
              <Card className="border-0">
                <CardBody>
                  ...
                  <p className="card-text">
                    In quisque dolor, aliquam faucibus. Gravida diam ornare egestas proin quis odio suspendisse pellentesque. Condimentum risus,
                    rutrum curabitur faucibus mi a turpis morbi. Nulla euismod dolor quis amet sed.
                  </p>
                </CardBody>
              </Card>
            </SwiperSlide>
