      ...
      <section className="container py-5 my-md-2 my-lg-3 my-xl-4">
        <Row className="pt-xxl-2">
          <Col lg={9} xl={8} className="pe-lg-4 pe-xl-0">
            ...
            <div className="d-flex flex-wrap pt-3 pt-md-4 pt-xl-5 mt-xl-n2">
          ...
          <Col lg={3} as={'aside'} className="offset-xl-1 pt-4 pt-lg-0" style={{ marginTop: '-7rem' }}>
            <div className="position-sticky top-0 mt-2 mt-md-3 mt-lg-0" style={{ paddingTop: '7rem' }}>
              <h4 className="mb-4">Share this post:</h4>
              <div className="d-flex mt-n3 ms-n3 mb-lg-5 mb-4 pb-3 pb-lg-0">
                <Link className="btn btn-outline-secondary btn-icon btn-sm btn-instagram rounded-circle mt-3 ms-3" to="" aria-label="Instagram">
                  <i className="ai-instagram" />
                </Link>
                <Link className="btn btn-outline-secondary btn-icon btn-sm btn-facebook rounded-circle mt-3 ms-3" to="" aria-label="Facebook">
                  <i className="ai-facebook" />
                </Link>
                <Link className="btn btn-outline-secondary btn-icon btn-sm btn-telegram rounded-circle mt-3 ms-3" to="" aria-label="Telegram">
                  <i className="ai-telegram" />
                </Link>
                <Link className="btn btn-outline-secondary btn-icon btn-sm btn-x rounded-circle mt-3 ms-3" to="" aria-label="X">
                  <i className="ai-x" />
                </Link>
              </div>
              ...
              <ul className="list-unstyled mb-0">
                <li className="border-bottom pb-3 mb-3">
                  <span className="h6 mb-0">
                    <Link to="/blog/single-v2">Instagram trends that will definitely work and bring results in the new 2022</Link>
                  </span>
                </li>
                <li className="border-bottom pb-3 mb-3">
                  <span className="h6 mb-0">
                    <Link to="/blog/single-v3">A session with a psychologist as a personal choice</Link>
                  </span>
                </li>
                <li className="border-bottom pb-3 mb-3">
                  <span className="h6 mb-0">
                    <Link to="/blog/single-v2">Travel destinations to inspire and restore resources</Link>
                  </span>
                </li>
                <li>
                  <span className="h6 mb-0">
                    <Link to="/blog/single-v3">How to look for inspiration for new goals in life?</Link>
                  </span>
                </li>
              </ul>
            </div>
