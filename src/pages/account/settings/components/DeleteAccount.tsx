      ...
      <section className="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
        <CardBody>
          <div className="d-flex align-items-center pb-4 mt-sm-n1 mb-0 mb-lg-1 mb-xl-3">
            <i className="ai-trash text-primary lead pe-1 me-2" />
            <h2 className="h4 mb-0">Delete account</h2>
          </div>
          <Alert variant="warning" className="d-flex mb-4">
            <i className="ai-triangle-alert fs-xl me-2" />
            <p className="mb-0">
              When you delete your account, your public profile will be deactivated immediately. If you change your mind before the 14 days are up,
              sign in with your email and password, and we'll send a link to reactivate account.
          ...
          <div className="form-check">
            ...
            <label className="form-check-label text-dark fw-medium" htmlFor="confirm">
