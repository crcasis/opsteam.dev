...
import { Accordion, AccordionBody, AccordionHeader, AccordionItem, Col, Image, Row, Table } from 'react-bootstrap'
import { Link } from 'react-router-dom'

const Order = () => {
  return (
    <>
      <Accordion defaultActiveKey={'3'} className="accordion-alt accordion-orders" id="orders">
